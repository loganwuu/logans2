 ...
 */
function my_garland_preprocess_maintenance_page(&$variables) {
  // While markup for normal pages is split into page.tpl.php and html.tpl.php,
  // the markup for the maintenance page is all in the single
  // maintenance-page.tpl.php template. So, to have what's done in
  // my_garland_preprocess_html() also happen on the maintenance page, it has to be
  // called here.
  my_garland_preprocess_html($variables);
}

/**
 * Override or insert variables into the html template.
 */
function my_garland_preprocess_html(&$variables) {
 ...
 * Override or insert variables into the html template.
 */
function my_garland_process_html(&$variables) {
 ...
 */
function my_garland_preprocess_page(&$variables) {
 ...
 */
function my_garland_preprocess_node(&$variables) {
 ...
 */
function my_garland_preprocess_comment(&$variables) {
 ...
 */
function my_garland_preprocess_block(&$variables) {
 ...
 */
function my_garland_preprocess_region(&$variables) {
